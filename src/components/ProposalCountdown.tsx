...
export function getProposalCountdownState(deadlineLedger: number, currentLedger: number): CountdownState {
  ...
  if (secondsRemaining < DAY_SECONDS) {
    ...
    const minutes = Math.floor((secondsRemaining % HOUR_SECONDS) / MINUTE_SECONDS)
...
export default function ProposalCountdown({ deadlineLedger, currentLedger }: Readonly<Props>) {
